...
// $sql = 'SELECT personaldetails.application_no,personaldetails.applicant_name as name,ssc_details.mark as ssc_mark,hsc_details.mark as hsc_mark,ug_details.cgpa,personaldetails.mobilenumber as contact FROM personaldetails INNER JOIN ssc_details on ssc_details.application_no = personaldetails.application_no INNER JOIN hsc_details on hsc_details.application_no = personaldetails.application_no INNER JOIN ug_details on ug_details.application_no=personaldetails.application_no;';
...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
      ...
      <span class="fs-4">Departments</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto hf">
      
      <li>
        <a href="#" data-target="MSC_CS" class="nav-link link-body-emphasis target-btn">
        M.Sc. Computer Science
        </a>
      </li>
      <li>
        <a href="#" data-target="MSC_IT" class="nav-link link-body-emphasis target-btn">
        M.Sc. Information Technology
        </a>
      </li>
      <li>
        <a href="#" data-target="MSC_Botony" class="nav-link link-body-emphasis target-btn">
        M.Sc. Botony
        </a>
      </li>
      <li>
        <a href="#" data-target="MSC_Maths" class="nav-link link-body-emphasis target-btn">
        M.Sc. Mathematics
        </a>
      </li>
      <li>
        <a href="#" data-target="MA_English" class="nav-link link-body-emphasis target-btn">
        M.A. English
        </a>
      </li>
      <li class="nav-item">
        <a href="#" data-target="M.Com" class="nav-link active target-btn" aria-current="page">
          M.Com
        </a>
      </li>
...
<div class="flex-grow-1">
        ...
        <div class="container">
            <!-- Example: Page title -->
            <h1 class="mt-2">PG Applications</h1>
...
<script type="text/javascript">
    ...
    ajax: 'load_pg.php?dept=M.Sc.Information%20Technology',
    responsive:true,
    columns: [
    ...
    const targetValue = $(el.target).data('target');
    		...
    		table.ajax.url("load_pg.php?dept="+targetValue);
	 		table.ajax.reload();
